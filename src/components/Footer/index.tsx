import Fb from '../../assets/img/fb-icon-footer.png'
import Ig from '../../assets/img/ig-icon-footer.png'
import Gp from '../../assets/img/gplus-icon-footer.png'
import Tt from '../../assets/img/tt-icon-footer.png'
import Android from '../../assets/img/android-icon-footer.png'
import Ios from '../../assets/img/icon_apple_branco.png'
import Location from '../../assets/img/localizacao-icon-footer.png'
import Phone from '../../assets/img/cel-icon-footer.png'
import Email from '../../assets/img/email-icon-footer.png'
import Site from '../../assets/img/site.png'
import SaSilva from '../../assets/img/sasilva-logo.png'
